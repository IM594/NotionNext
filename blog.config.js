...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi, this is Zhaohao Lu!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zhaohao Lu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'INFJ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.luzhaohao.me', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'BLOG - Zhaohao Lu', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Zhaohao Lu', // 站点描述，被notion中的页面描述覆盖
